...
HD_PWD='J:/FEP/ETH1512/MZ7035/CH02_PL_AXI_ETH_RGMII/Miz_sys/Miz_sys.runs/bd_4bad_xlconstant_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_4bad_xlconstant_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_4bad_xlconstant_0_0.tcl

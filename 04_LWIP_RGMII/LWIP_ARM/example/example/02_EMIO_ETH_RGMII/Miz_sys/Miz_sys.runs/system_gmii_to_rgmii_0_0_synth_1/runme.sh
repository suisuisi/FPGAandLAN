...
HD_PWD='J:/FEP/ETH1512/MZ7035/CH01_EMIO_ETH_RGMII/Miz_sys/Miz_sys.runs/system_gmii_to_rgmii_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_gmii_to_rgmii_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_gmii_to_rgmii_0_0.tcl

...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_pins gmii_to_rgmii_0/rx_reset] [get_bd_pins gmii_to_rgmii_0/tx_reset] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins gmii_to_rgmii_0/clkin] [get_bd_pins processing_system7_0/FCLK_CLK0]

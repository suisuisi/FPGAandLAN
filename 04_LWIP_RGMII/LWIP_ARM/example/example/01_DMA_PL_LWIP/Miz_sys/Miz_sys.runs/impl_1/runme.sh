...
HD_PWD='F:/MIZ7035_Demon/s3/CH08_DMA_PL_LWIP/Miz_sys/Miz_sys.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dma_system_wrapper.tcl -notrace

...
HD_PWD='F:/MIZ7035_Demon/s3/CH08_DMA_PL_LWIP/Miz_sys/Miz_sys.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_system_wrapper.tcl

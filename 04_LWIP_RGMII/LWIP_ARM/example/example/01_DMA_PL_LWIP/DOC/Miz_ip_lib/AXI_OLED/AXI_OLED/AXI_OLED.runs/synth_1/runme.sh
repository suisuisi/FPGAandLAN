...
HD_PWD='D:/MIZ_SOC/CH14_AXI_OLED/AXI_OLED/AXI_OLED/AXI_OLED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SSD1306_OLED_ML.vds -m64 -mode batch -messageDb vivado.pb -notrace -source SSD1306_OLED_ML.tcl

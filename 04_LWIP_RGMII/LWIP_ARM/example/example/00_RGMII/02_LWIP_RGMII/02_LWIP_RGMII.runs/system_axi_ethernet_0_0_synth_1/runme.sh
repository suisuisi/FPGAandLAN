...
HD_PWD='F:/FILE/FPGA/ZYNQ/08_LAN/05_MB_DDR3_LWIP_RGMII/02_LWIP_RGMII/02_LWIP_RGMII.runs/system_axi_ethernet_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_ethernet_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_ethernet_0_0.tcl

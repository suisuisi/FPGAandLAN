...
HD_PWD='F:/FILE/FPGA/ZYNQ/08_LAN/05_MB_DDR3_LWIP_RGMII/02_LWIP_RGMII/02_LWIP_RGMII.runs/bd_4bad_mac_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_4bad_mac_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_4bad_mac_0.tcl

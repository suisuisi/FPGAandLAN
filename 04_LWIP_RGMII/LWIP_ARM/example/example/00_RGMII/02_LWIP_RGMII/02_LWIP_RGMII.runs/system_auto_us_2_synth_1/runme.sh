...
HD_PWD='F:/FILE/FPGA/ZYNQ/08_LAN/05_MB_DDR3_LWIP_RGMII/02_PL_AXI_LWIP_RGMII/02_LWIP_RGMII/02_LWIP_RGMII.runs/system_auto_us_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_auto_us_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_auto_us_2.tcl

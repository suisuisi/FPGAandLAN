...
HD_PWD='F:/FILE/FPGA/ZYNQ/08_LAN/05_MB_DDR3_LWIP_RGMII/02_PL_AXI_LWIP_RGMII/Miz_sys/Miz_sys.runs/bd_4bad_util_vector_logic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_4bad_util_vector_logic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_4bad_util_vector_logic_0_0.tcl

...
# <./pl_eth_sgmii/pl_eth_sgmii.xpr> in the current working folder.

# set list_projs [get_projects -quiet]
# if { $list_projs eq "" } {
   # create_project pl_eth_sgmii pl_eth_sgmii -part xczu9eg-ffvb1156-2-i
...
proc create_root_design { parentCell } {
  ...
  set sfp [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:sgmii_rtl:1.0 sfp ]
...
CONFIG.c_sg_use_stsapp_length {1} \
  ...
  connect_bd_intf_net -intf_net axi_eth_0_sgmii [get_bd_intf_ports sfp] [get_bd_intf_pins axi_eth_0/sgmii]

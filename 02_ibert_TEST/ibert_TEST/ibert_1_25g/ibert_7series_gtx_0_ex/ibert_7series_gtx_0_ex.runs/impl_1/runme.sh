...
HD_PWD='D:/vivado_project/miz7035/ibert_1_25g/ibert_7series_gtx_0_ex/ibert_7series_gtx_0_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log example_ibert_7series_gtx_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source example_ibert_7series_gtx_0.tcl -notrace

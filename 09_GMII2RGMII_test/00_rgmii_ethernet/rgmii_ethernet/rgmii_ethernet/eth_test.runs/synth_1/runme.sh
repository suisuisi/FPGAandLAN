...
HD_PWD='D:/demo_AX7204/19 ethernet_test_1g_100m/rgmii_ethernet/eth_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ethernet_port.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ethernet_port.tcl

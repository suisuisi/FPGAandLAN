...
HD_PWD='D:/demo_AX7204/19 ethernet_test_1g_100m/rgmii_ethernet/eth_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ethernet_port.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ethernet_port.tcl -notrace

...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -mcpu=cortex-a9 -mfpu=vfpv3 -mfloat-abi=hard -nostartfiles -g
END
...
BEGIN LIBRARY
 ...
 PARAMETER LIBRARY_VER = 1.75
 PARAMETER PROC_INSTANCE = ps7_cortexa9_0
 PARAMETER 1000basex_phy_address = 6
 PARAMETER use_1000basex = true
 PARAMETER use_axieth_on_zynq = 0
 PARAMETER use_emaclite_on_zynq = 0
 PARAMETER use_pcs_pma_core_on_zynq = true
END

...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set an_adv_config_vector [ create_bd_port -dir I -from 15 -to 0 an_adv_config_vector ]
  set configuration_vector [ create_bd_port -dir I -from 4 -to 0 configuration_vector ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {SD 1#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0} \
  ...
  connect_bd_net -net an_adv_config_vector_1 [get_bd_ports an_adv_config_vector] [get_bd_pins gig_ethernet_pcs_pma_0/an_adv_config_vector]
  connect_bd_net -net configuration_vector_1 [get_bd_ports configuration_vector] [get_bd_pins gig_ethernet_pcs_pma_0/configuration_vector]
  ...
  connect_bd_net -net gig_ethernet_pcs_pma_0_mdio_o [get_bd_pins gig_ethernet_pcs_pma_0/mdio_o] [get_bd_pins processing_system7_0/ENET1_MDIO_I]
  connect_bd_net -net gig_ethernet_pcs_pma_0_status_vector [get_bd_ports status_vector] [get_bd_pins gig_ethernet_pcs_pma_0/status_vector]
  ...
  connect_bd_net -net processing_system7_0_ENET1_GMII_TX_EN [get_bd_pins gig_ethernet_pcs_pma_0/gmii_tx_en] [get_bd_pins processing_system7_0/ENET1_GMII_TX_EN]
  connect_bd_net -net processing_system7_0_ENET1_GMII_TX_ER [get_bd_pins gig_ethernet_pcs_pma_0/gmii_tx_er] [get_bd_pins processing_system7_0/ENET1_GMII_TX_ER]
  connect_bd_net -net processing_system7_0_ENET1_MDIO_MDC [get_bd_pins gig_ethernet_pcs_pma_0/mdc] [get_bd_pins processing_system7_0/ENET1_MDIO_MDC]
  connect_bd_net -net processing_system7_0_ENET1_MDIO_O [get_bd_pins gig_ethernet_pcs_pma_0/mdio_i] [get_bd_pins processing_system7_0/ENET1_MDIO_O]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins gig_ethernet_pcs_pma_0/independent_clock_bufg] [get_bd_pins processing_system7_0/FCLK_CLK0]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins gig_ethernet_pcs_pma_0/an_adv_config_val] [get_bd_pins gig_ethernet_pcs_pma_0/an_restart_config] [get_bd_pins gig_ethernet_pcs_pma_0/configuration_valid] [get_bd_pins processing_system7_0/ENET1_GMII_COL] [get_bd_pins processing_system7_0/ENET1_GMII_CRS] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins gig_ethernet_pcs_pma_0/signal_detect] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins gig_ethernet_pcs_pma_0/phyaddr] [get_bd_pins xlconstant_2/dout]

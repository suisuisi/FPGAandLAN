...
HD_PWD='F:/FILE/FPGA/ZYNQ/08_LAN/05_LWIP_1g_sfp/example/LWIP_sfp/lwip_sfp/Miz_sys/Miz_sys.runs/system_gig_ethernet_pcs_pma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_gig_ethernet_pcs_pma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_gig_ethernet_pcs_pma_0_0.tcl

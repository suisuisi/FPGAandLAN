...
HD_PWD='E:/MIA701SRC/aurora_8b10b_ex/aurora_8b10b_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log aurora_8b10b_exdes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source aurora_8b10b_exdes.tcl -notrace

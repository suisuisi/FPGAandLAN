...
HD_PWD='e:/DS_SRC/MIA701/aurora_test/aurora_8b10b_ex/aurora_8b10b_ex.runs/vio_7series_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_7series.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_7series.tcl

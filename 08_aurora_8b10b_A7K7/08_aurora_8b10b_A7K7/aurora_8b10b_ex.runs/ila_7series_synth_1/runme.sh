...
HD_PWD='e:/DS_SRC/MIA701/aurora_test/aurora_8b10b_ex/aurora_8b10b_ex.runs/ila_7series_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_7series.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_7series.tcl

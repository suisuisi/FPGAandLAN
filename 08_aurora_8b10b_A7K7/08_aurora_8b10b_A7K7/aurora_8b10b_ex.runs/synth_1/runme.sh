...
HD_PWD='E:/MIA701SRC/aurora_8b10b_ex/aurora_8b10b_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aurora_8b10b_exdes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aurora_8b10b_exdes.tcl

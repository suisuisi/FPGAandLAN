...
#
# Generated by export_simulation on Tue Sep 19 13:40:06 +0800 2017
#
################################################################################
...
switch to the './vio_7series.sh' script.

./vio_7series.sh -reset_run
...
./vio_7series.sh -noclean_files

For more information on the script, please type './vio_7series.sh -help'.

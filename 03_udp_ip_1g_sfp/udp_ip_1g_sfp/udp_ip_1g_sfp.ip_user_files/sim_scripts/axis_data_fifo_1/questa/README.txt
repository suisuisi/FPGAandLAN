...
#
# Generated by export_simulation on Tue Mar 31 21:31:02 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './axis_data_fifo_1.sh' script.

./axis_data_fifo_1.sh -reset_run
...
./axis_data_fifo_1.sh -noclean_files

For more information on the script, please type './axis_data_fifo_1.sh -help'.
